...
export default function Hero() {
  return (
    <section className="py-10 px-4 md:px-8 mx-auto text-center md:text-left md:flex items-center justify-between max-w-7xl ">
      <motion.div
        initial="hidden"
        animate="show"
        variants={container}
        className="flex-1"
      >
        <motion.h1 className="text-4xl md:text-5xl font-bold mb-4 space-y-2">
          {[
            'Get a',
            'Hydrogen card,',
            'no maintenance',
            ...
            <motion.div
              ...
              className={`block bg-gradient-to-r ${
                i === 1 || i === 2
                  ? 'from-[#7D7D7D] via-white to-gray-900'
                  : 'from-[#7D7D7D] via-white to-[#7D7D7D]'
...
<motion.div
  ...
  className="mt-10 md:mt-0 flex items-center justify-end flex-1 gap-0 pr-0"
>
  <motion.img
    ...
    initial={{ x: 0 }}
    animate={{ x: 10 }} // subtle nudge to the right
